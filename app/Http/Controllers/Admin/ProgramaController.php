...
class ProgramaController extends Controller
{
    ...
    public function index()
    {
      ...
      $activos=Programa::where('visible',1)->count();
      $desactivos=Programa::where('visible',0)->count();
      return view('programas.index',compact('programas','temporadas','activos','desactivos'));
    }
    ...
    {
      $data=Programa::where('id',$id)->first();
      return compact('data');
    }
