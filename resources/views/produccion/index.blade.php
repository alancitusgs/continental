        ...
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            ...
            <div class="d-flex align-items-center my-2">
              <h3 class="mb-0 me-2">{{$producciones->count()}}</h3>
  ...
  <div class="col-sm-6 col-xl-4">
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            <span>Porudccion General Activos</span>
            <div class="d-flex align-items-center my-2">
              <h3 class="mb-0 me-2">{{$activos}}</h3>
              <p class="text-success mb-0">({{($activos*100)/$producciones->count()}}%)</p>
            </div>
  ...
  <div class="col-sm-6 col-xl-4">
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            <span>Produccion General Desactivos</span>
            <div class="d-flex align-items-center my-2">
              <h3 class="mb-0 me-2">{{$desactivos}}</h3>
              <p class="text-danger mb-0">({{($desactivos*100)/$producciones->count()}}%)</p>
            </div>
            <!--<p class="mb-0">Last week analytics</p>-->
          </div>
          <div class="avatar">
...
<div class="card">
  <div class="card-datatable table-responsive">
    <table class="datatables-cursos table">
      ...
      <tbody>
        @foreach($producciones as $key => $data)
        <tr>
          <th>{{$key +1}}</th>
          <th>{{$data->codigo_asignatura}}</th>
          <th>{{$data->nombre_curso}}</th>
          <th>
          @if ($data->modalidad == 1)
           P
          @elseif ($data->modalidad == 2)
           SP
          @elseif ($data->modalidad == 3)
           D
          @else
          Valor Desconocido
          @endif
