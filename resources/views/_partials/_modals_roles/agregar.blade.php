<!-- Add Role Modal -->
<div class="modal fade" id="AgregarRol" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-add-new-role">
    <div class="modal-content p-3 p-md-5">
      <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-body">
        <div class="text-center mb-4">
          <h3 class="role-title mb-2">Nuevo Rol</h3>
          <!--<p class="text-muted">Set role permissions</p>-->
        </div>
        <!-- Add role form -->
        <form id="agregarRol" class="row g-3"  method="post" action="{{ route('AgregarRol') }}" data-token="{{ csrf_token() }}">
          @csrf
...
document.addEventListener("DOMContentLoaded", function () {
  const nuevoRolModal = document.getElementById("AgregarRol");
  nuevoRolModal.addEventListener("shown.bs.modal", function () {
  nuevoRolModal.querySelector("#nombre").focus();
  });
  const formulario = nuevoRolModal.querySelector("#agregarRol");
