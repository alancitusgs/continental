    ...
    <div class="modal-content p-3 p-md-5">
      ...
      <div class="modal-body">
        <div class="text-center mb-4">
          <h3 class="role-title mb-2">Editar Rol</h3>
          <!--<p class="text-muted">Set role permissions</p>-->
        </div>
        <!-- Add role form -->
        <form id="editarRol" class="row g-3"  method="post" action="{{ route('EditarRol') }}" data-token="{{ csrf_token() }}">
          @csrf
          ...
          <div class="col-12 mb-4">
            ...
            <label class="switch switch-primary">
              <input type="checkbox" id="visible" name="visible" class="switch-input"/>
...
document.addEventListener("DOMContentLoaded", function () {
  const editarRolModal = document.getElementById("EditarRol");
    editarRolModal.addEventListener("shown.bs.modal", function () {
    editarRolModal.querySelector("#nombre").focus();
    });
  const formulario = editarRolModal.querySelector("#editarRol");
